...
class Yamtrack(id: Long) : BaseTracker(id, "Yamtrack"), DeletableTracker {
    ...
    companion object {
        ...
        /**
         * Parses a Yamtrack tracking URL of the form
         * `{base}/details/{source}/{mediaType}/{mediaId}[/{slug}]` and returns the decoded
         * `(source, mediaType, mediaId)`.
         */
     ...
     */
    fun enrichSearchResults(items: List<TrackSearch>): Flow<TrackSearch> = channelFlow {
        items.forEach { item ->
            launch {
